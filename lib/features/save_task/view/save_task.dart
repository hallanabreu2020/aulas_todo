...
class SaveTaskView extends StatelessWidget {
  const SaveTaskView({super.key});
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("Nova Tarefa", style: Theme.of(context).textTheme.displayLarge),
              ...
              Padding(
                padding: const EdgeInsets.all(20.0),
                child: ElevatedButton(onPressed: (){Navigator.pushNamed(context, "/register");}, child: const Text("Salvar")),
              ),
            ],
          ),
        ),
